...
const Homepage = ({ foods, hero }) => {
  ...
  const itemClass = "item min-h-[30rem] min-w-[30rem] w-[300px] p-[90px] transition-all duration-300 ease-in-out border-none mb-[30px] overflow-hidden"; // Added overflow-hidden to maintain rounded corners on hover
  const imgClass = "w-full h-full rounded-2xl border-double border-opacity-20 shadow-md object-cover";  
    ...
    const containerClass = "overflow-x-hidden"; // This will hide the horizontal scrollbar
